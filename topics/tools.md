...
|[Annex WCAG 2.2 markup scan](https://yakupefecaliskann.github.io/annex-site/tools/scan/)|Checks a page's markup against 14 WCAG 2.2 rules. The rules run in your browser in both modes: pasting a page source sends nothing anywhere, and scanning by address sends only the address to a proxy that fetches the page. Names the criteria it cannot judge automatically instead of scoring them as passed.|
